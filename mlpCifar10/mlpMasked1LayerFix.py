...
""" # Load the pre-calculated weights for fc1
fc1_weights = torch.load('path/to/weights.pt')

# Create an instance of the MLP model
model = MLP(input_dim, hidden_dim, output_dim, num_layers, sparsity, diagPos, apply_mask)

# Set the weights of fc1 to the pre-calculated weights
model.fc1.weight.data = fc1_weights

# Train only the recurrent_layer1
optimizer = torch.optim.SGD(model.recurrent_layer1.parameters(), lr=learning_rate)
