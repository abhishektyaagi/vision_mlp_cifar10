...
parser.add_argument('--diagPos1', nargs='+', default='0', metavar='P', help='diagonal position (default: 0)')
...
def test(epoch):
    ...
    if acc > best_acc:
        ...
        if not os.path.isdir('checkpoint'):
            os.mkdir('checkpoint')
        torch.save(state, '/p/dataset/abhishek/'+args.net+args.expName+str(args.expNum)+'_'+str(len(args.diagPos1))+'-{}-ckpt.t7'.format(args.patch))
        best_acc = acc
