...
def generate_bash_script(experiment_name,sparsity):
    ...
    random_selection1 = random_selection1[:100]
    random_selection2 = random_selection2[:100]
    random_selection3 = random_selection3[:100]
    random_selection4 = random_selection4[:100]
