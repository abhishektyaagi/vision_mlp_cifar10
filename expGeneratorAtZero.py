...
def generate_bash_script(experiment_name,sparsity):
    ...
    #Make sure that the first diagonal always starts at position zero and rest are randomly chosen
    random_selection1 = random_combinations(possible_positions1, num_diagonals1, 10)
    random_selection2 = random_combinations(possible_positions2, num_diagonals2, 10)
    random_selection3 = random_combinations(possible_positions3, num_diagonals3, 10)
    random_selection4 = random_combinations(possible_positions4, num_diagonals4, 10)

    #Replace the first element of all values in above lists with 0
    for i in range(10):
        random_selection1[i] = (0,) + random_selection1[i][1:]
        random_selection2[i] = (0,) + random_selection2[i][1:]
        random_selection3[i] = (0,) + random_selection3[i][1:]
        random_selection4[i] = (0,) + random_selection4[i][1:]
